...
namespace Mx.Peppol.Lookup.Reader.ds
{
    ...
    public partial class SignedInfo : Mx.Peppol.Lookup.Reader.BdxSmp201605.XmlCommonBase
    {
        #region Constructors
        /// <summary>
        ...
        protected override void Init()
        {
            ...
            m_Id = null;
            m_CanonicalizationMethod = new Mx.Peppol.Lookup.Reader.ds.CanonicalizationMethod("CanonicalizationMethod");
            m_SignatureMethod = new Mx.Peppol.Lookup.Reader.ds.SignatureMethod("SignatureMethod");
            m_Reference = new Mx.Peppol.Lookup.Reader.BdxSmp201605.XmlObjectCollection<Mx.Peppol.Lookup.Reader.ds.Reference>("Reference", "http://www.w3.org/2000/09/xmldsig#", 1, -1, false);
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
        ...
        {
            Mx.Peppol.Lookup.Reader.ds.SignedInfo newObject = new Mx.Peppol.Lookup.Reader.ds.SignedInfo(_elementName);
            newObject.m_Id = m_Id;
            newObject.m_CanonicalizationMethod = null;
            if (m_CanonicalizationMethod != null)
                newObject.m_CanonicalizationMethod = (Mx.Peppol.Lookup.Reader.ds.CanonicalizationMethod)m_CanonicalizationMethod.Clone();
            newObject.m_SignatureMethod = null;
            if (m_SignatureMethod != null)
                newObject.m_SignatureMethod = (Mx.Peppol.Lookup.Reader.ds.SignatureMethod)m_SignatureMethod.Clone();
            foreach (Mx.Peppol.Lookup.Reader.ds.Reference o in m_Reference)
                newObject.m_Reference.Add((Mx.Peppol.Lookup.Reader.ds.Reference)o.Clone());
...
// ##HAND_CODED_BLOCK_END ID="Additional clone"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
        ...
        /// </remarks>
        [LiquidTechnologies.Runtime.Standard20.ElementInfoSeqClsMnd("CanonicalizationMethod", "http://www.w3.org/2000/09/xmldsig#", LiquidTechnologies.Runtime.Standard20.XmlObjectBase.XmlElementType.Element, typeof(Mx.Peppol.Lookup.Reader.ds.CanonicalizationMethod), false)]
        public Mx.Peppol.Lookup.Reader.ds.CanonicalizationMethod CanonicalizationMethod
        {
            get 
            { 
        ...
        protected Mx.Peppol.Lookup.Reader.ds.CanonicalizationMethod m_CanonicalizationMethod;
        ...
        /// If this property is set, then the object will be COPIED. If the property is set to null an exception is raised.
        /// </remarks>
        [LiquidTechnologies.Runtime.Standard20.ElementInfoSeqClsMnd("SignatureMethod", "http://www.w3.org/2000/09/xmldsig#", LiquidTechnologies.Runtime.Standard20.XmlObjectBase.XmlElementType.Element, typeof(Mx.Peppol.Lookup.Reader.ds.SignatureMethod), false)]
        public Mx.Peppol.Lookup.Reader.ds.SignatureMethod SignatureMethod
        {
            get 
            { 
        ...
        protected Mx.Peppol.Lookup.Reader.ds.SignatureMethod m_SignatureMethod;
        ...
        public Mx.Peppol.Lookup.Reader.BdxSmp201605.XmlObjectCollection<Mx.Peppol.Lookup.Reader.ds.Reference> Reference
        {
            get { return m_Reference; }
        }
        protected Mx.Peppol.Lookup.Reader.BdxSmp201605.XmlObjectCollection<Mx.Peppol.Lookup.Reader.ds.Reference> m_Reference;
