...
namespace Mx.Peppol.Lookup.Reader.ds
{
    ...
    public partial class DSAKeyValue_Seq : Mx.Peppol.Lookup.Reader.BdxSmp201605.XmlCommonBase
    {
        #region Constructors
        /// <summary>
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
        ...
        {
            Mx.Peppol.Lookup.Reader.ds.DSAKeyValue_Seq newObject = new Mx.Peppol.Lookup.Reader.ds.DSAKeyValue_Seq(_elementName);
            newObject.m_P = m_P;
            newObject.m_Q = m_Q;
