...
{
    /// <summary>
    /// This class represents the ComplexType ValidatorType
    /// </summary>
    [LiquidTechnologies.Runtime.Standard20.XmlObjectInfo(LiquidTechnologies.Runtime.Standard20.XmlObjectBase.XmlElementGroupType.Sequence,
                                                    ...
                                                    "ValidatorType", "http://difi.no/xsd/certvalidator/1.0", false, true, false)]
    public partial class ValidatorType : Mx.Xml.CertValidator.XmlCommonBase
                    , Mx.Xml.tns.IExtensibleType
    {
        ...
        {
            _elementName = "ValidatorType";
            Init();
        }
        public ValidatorType(string elementName)
        {
        ...
        protected override void Init()
        {
            ...
            m_ValidatorTypeData = new Mx.Xml.tns.ValidatorType_Type("ValidatorTypeData");
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
        ...
        {
            Mx.Xml.tns.ValidatorType newObject = new Mx.Xml.tns.ValidatorType(_elementName);
            ...
            newObject.m_ValidatorTypeData = null;
            if (m_ValidatorTypeData != null)
                newObject.m_ValidatorTypeData = (Mx.Xml.tns.ValidatorType_Type)m_ValidatorTypeData.Clone();
...
// ##HAND_CODED_BLOCK_END ID="Additional clone"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
        ...
        #region Attribute - ValidatorTypeData
        /// <summary>
        /// Holds all the information contained within the element
        /// </summary>
        /// <remarks>
        ...
        /// </remarks>
        [LiquidTechnologies.Runtime.Standard20.ElementInfoSeqClsMnd("ValidatorTypeData", "http://difi.no/xsd/certvalidator/1.0", LiquidTechnologies.Runtime.Standard20.XmlObjectBase.XmlElementType.PseudoElement, typeof(Mx.Xml.tns.ValidatorType_Type), false)]
        public Mx.Xml.tns.ValidatorType_Type ValidatorTypeData
        {
            get 
            { 
                return m_ValidatorTypeData;  
            }
            set 
            { 
                Throw_IfPropertyIsNull(value, "ValidatorTypeData");
                m_ValidatorTypeData = value;
            }
        }
        protected Mx.Xml.tns.ValidatorType_Type m_ValidatorTypeData;
