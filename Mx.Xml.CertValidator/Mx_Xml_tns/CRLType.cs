...
{
    /// <summary>
    /// This class represents the ComplexType CRLType
    /// </summary>
    [LiquidTechnologies.Runtime.Standard20.XmlObjectInfo(LiquidTechnologies.Runtime.Standard20.XmlObjectBase.XmlElementGroupType.Sequence,
                                                    ...
                                                    "CRLType", "http://difi.no/xsd/certvalidator/1.0", true, false, false)]
    public partial class CRLType : Mx.Xml.CertValidator.XmlCommonBase
    {
        #region Constructors
        /// <summary>
        /// Constructor for CRLType
        /// </summary>
        /// <remarks>
        ...
        public CRLType()
        {
            _elementName = "CRLType";
            Init();
        }
        public CRLType(string elementName)
        {
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
        ...
        {
            Mx.Xml.tns.CRLType newObject = new Mx.Xml.tns.CRLType(_elementName);
