...
{
    /// <summary>
    /// This class represents the ComplexType JunctionType
    /// </summary>
    [LiquidTechnologies.Runtime.Standard20.XmlObjectInfo(LiquidTechnologies.Runtime.Standard20.XmlObjectBase.XmlElementGroupType.Sequence,
                                                    ...
                                                    "JunctionType", "http://difi.no/xsd/certvalidator/1.0", false, true, false)]
    public partial class JunctionType : Mx.Xml.CertValidator.XmlCommonBase
                    , Mx.Xml.tns.IExtensibleType
    {
        #region Constructors
        /// <summary>
        /// Constructor for JunctionType
        /// </summary>
        /// <remarks>
        ...
        public JunctionType()
        {
            _elementName = "JunctionType";
            Init();
        }
        public JunctionType(string elementName)
        {
        ...
        protected override void Init()
        {
            ...
            m_JunctionTypeData = new Mx.Xml.tns.JunctionType_Type("JunctionTypeData");
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
        ...
        {
            Mx.Xml.tns.JunctionType newObject = new Mx.Xml.tns.JunctionType(_elementName);
            ...
            newObject.m_JunctionTypeData = null;
            if (m_JunctionTypeData != null)
                newObject.m_JunctionTypeData = (Mx.Xml.tns.JunctionType_Type)m_JunctionTypeData.Clone();
...
// ##HAND_CODED_BLOCK_END ID="Additional clone"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
        ...
        #region Attribute - JunctionTypeData
        /// <summary>
        /// Holds all the information contained within the element
        /// </summary>
        /// <remarks>
        ...
        /// </remarks>
        [LiquidTechnologies.Runtime.Standard20.ElementInfoSeqClsMnd("JunctionTypeData", "http://difi.no/xsd/certvalidator/1.0", LiquidTechnologies.Runtime.Standard20.XmlObjectBase.XmlElementType.PseudoElement, typeof(Mx.Xml.tns.JunctionType_Type), false)]
        public Mx.Xml.tns.JunctionType_Type JunctionTypeData
        {
            get 
            { 
                return m_JunctionTypeData;  
            }
            set 
            { 
                Throw_IfPropertyIsNull(value, "JunctionTypeData");
                m_JunctionTypeData = value;
            }
        }
        protected Mx.Xml.tns.JunctionType_Type m_JunctionTypeData;
