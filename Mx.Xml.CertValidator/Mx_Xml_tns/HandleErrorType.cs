...
{
    /// <summary>
    /// This class represents the ComplexType HandleErrorType
    /// </summary>
    [LiquidTechnologies.Runtime.Standard20.XmlObjectInfo(LiquidTechnologies.Runtime.Standard20.XmlObjectBase.XmlElementGroupType.Sequence,
                                                    ...
                                                    "HandleErrorType", "http://difi.no/xsd/certvalidator/1.0", false, true, false)]
    public partial class HandleErrorType : Mx.Xml.CertValidator.XmlCommonBase
                    , Mx.Xml.tns.IExtensibleType
    {
        #region Constructors
        /// <summary>
        /// Constructor for HandleErrorType
        /// </summary>
        /// <remarks>
        ...
        {
            _elementName = "HandleErrorType";
            Init();
        }
        public HandleErrorType(string elementName)
        {
        ...
        protected override void Init()
        {
            ...
            m_HandleErrorTypeData = new Mx.Xml.tns.HandleErrorType_Type("HandleErrorTypeData");
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
        ...
        {
            Mx.Xml.tns.HandleErrorType newObject = new Mx.Xml.tns.HandleErrorType(_elementName);
            ...
            newObject.m_HandleErrorTypeData = null;
            if (m_HandleErrorTypeData != null)
                newObject.m_HandleErrorTypeData = (Mx.Xml.tns.HandleErrorType_Type)m_HandleErrorTypeData.Clone();
...
// ##HAND_CODED_BLOCK_END ID="Additional clone"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
        ...
        #region Attribute - HandleErrorTypeData
        /// <summary>
        /// Holds all the information contained within the element
        /// </summary>
        /// <remarks>
        ...
        /// </remarks>
        [LiquidTechnologies.Runtime.Standard20.ElementInfoSeqClsMnd("HandleErrorTypeData", "http://difi.no/xsd/certvalidator/1.0", LiquidTechnologies.Runtime.Standard20.XmlObjectBase.XmlElementType.PseudoElement, typeof(Mx.Xml.tns.HandleErrorType_Type), false)]
        public Mx.Xml.tns.HandleErrorType_Type HandleErrorTypeData
        {
            get 
            { 
                return m_HandleErrorTypeData;  
            }
            set 
            { 
                Throw_IfPropertyIsNull(value, "HandleErrorTypeData");
                m_HandleErrorTypeData = value;
            }
        }
        protected Mx.Xml.tns.HandleErrorType_Type m_HandleErrorTypeData;
