...
{
    /// <summary>
    /// This class represents the ComplexType CriticalExtensionRecognizedType
    /// </summary>
    [LiquidTechnologies.Runtime.Standard20.XmlObjectInfo(LiquidTechnologies.Runtime.Standard20.XmlObjectBase.XmlElementGroupType.Sequence,
                                                    ...
                                                    "CriticalExtensionRecognizedType", "http://difi.no/xsd/certvalidator/1.0", true, false, false)]
    public partial class CriticalExtensionRecognizedType : Mx.Xml.CertValidator.XmlCommonBase
    {
        #region Constructors
        /// <summary>
        /// Constructor for CriticalExtensionRecognizedType
        /// </summary>
        /// <remarks>
        ...
        /// </remarks>
        public CriticalExtensionRecognizedType()
        {
            _elementName = "CriticalExtensionRecognizedType";
            Init();
        }
        public CriticalExtensionRecognizedType(string elementName)
        {
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
        ...
        {
            Mx.Xml.tns.CriticalExtensionRecognizedType newObject = new Mx.Xml.tns.CriticalExtensionRecognizedType(_elementName);
