...
{
    /// <summary>
    /// This class represents the Element TryType_Type
    /// </summary>
    [LiquidTechnologies.Runtime.Standard20.XmlObjectInfo(LiquidTechnologies.Runtime.Standard20.XmlObjectBase.XmlElementGroupType.Sequence,
                                                    ...
                                                    "TryType_Type", "http://difi.no/xsd/certvalidator/1.0", false, false, false)]
    public partial class TryType_Type : Mx.Xml.CertValidator.XmlCommonBase
    {
        #region Constructors
        /// <summary>
        /// Constructor for TryType_Type
        /// </summary>
        /// <remarks>
        ...
        public TryType_Type()
        {
            _elementName = "TryType_Type";
            Init();
        }
        public TryType_Type(string elementName)
        {
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
        ...
        {
            Mx.Xml.tns.TryType_Type newObject = new Mx.Xml.tns.TryType_Type(_elementName);
