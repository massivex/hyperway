...
{
    /// <summary>
    /// This class represents the ComplexType ExtensibleType
    /// </summary>
    [LiquidTechnologies.Runtime.Standard20.XmlObjectInfo(LiquidTechnologies.Runtime.Standard20.XmlObjectBase.XmlElementGroupType.Sequence,
                                                    ...
                                                    "ExtensibleType", "http://difi.no/xsd/certvalidator/1.0", false, true, false)]
    public partial class ExtensibleType : Mx.Xml.CertValidator.XmlCommonBase
                    , Mx.Xml.tns.IExtensibleType
    {
        #region Constructors
        /// <summary>
        /// Constructor for ExtensibleType
        /// </summary>
        /// <remarks>
        ...
        {
            _elementName = "ExtensibleType";
            Init();
        }
        public ExtensibleType(string elementName)
        {
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
        ...
        {
            Mx.Xml.tns.ExtensibleType newObject = new Mx.Xml.tns.ExtensibleType(_elementName);
