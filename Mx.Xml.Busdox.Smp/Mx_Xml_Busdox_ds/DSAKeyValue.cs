...
namespace Mx.Xml.Busdox.ds
{
    ...
    public partial class DSAKeyValue : Mx.Xml.Busdox.Smp.XmlCommonBase
    {
        #region Constructors
        /// <summary>
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
        ...
        {
            Mx.Xml.Busdox.ds.DSAKeyValue newObject = new Mx.Xml.Busdox.ds.DSAKeyValue(_elementName);
            newObject.m_DSAKeyValue_Seq = null;
            if (m_DSAKeyValue_Seq != null)
                newObject.m_DSAKeyValue_Seq = (Mx.Xml.Busdox.ds.DSAKeyValue_Seq)m_DSAKeyValue_Seq.Clone();
            newObject.m_G = m_G;
            newObject.m_Y = m_Y;
            newObject.m_J = m_J;
            newObject.m_DSAKeyValue_SeqA = null;
            if (m_DSAKeyValue_SeqA != null)
                newObject.m_DSAKeyValue_SeqA = (Mx.Xml.Busdox.ds.DSAKeyValue_SeqA)m_DSAKeyValue_SeqA.Clone();
...
// ##HAND_CODED_BLOCK_END ID="Additional clone"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
        ...
        /// </remarks>
        [LiquidTechnologies.Runtime.Standard20.ElementInfoSeqClsOpt("DSAKeyValue_Seq", "", LiquidTechnologies.Runtime.Standard20.XmlObjectBase.XmlElementType.PseudoElement, typeof(Mx.Xml.Busdox.ds.DSAKeyValue_Seq))]
        public Mx.Xml.Busdox.ds.DSAKeyValue_Seq DSAKeyValue_Seq
        {
            get
            { 
        ...
        protected Mx.Xml.Busdox.ds.DSAKeyValue_Seq m_DSAKeyValue_Seq;
        ...
        /// It is optional, initially it is null.
        /// </remarks>
        [LiquidTechnologies.Runtime.Standard20.ElementInfoSeqClsOpt("DSAKeyValue_SeqA", "", LiquidTechnologies.Runtime.Standard20.XmlObjectBase.XmlElementType.PseudoElement, typeof(Mx.Xml.Busdox.ds.DSAKeyValue_SeqA))]
        public Mx.Xml.Busdox.ds.DSAKeyValue_SeqA DSAKeyValue_SeqA
        {
            get
            { 
        ...
        protected Mx.Xml.Busdox.ds.DSAKeyValue_SeqA m_DSAKeyValue_SeqA;
