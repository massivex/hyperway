...
namespace Mx.Xml.Busdox.ds
{
    ...
    public partial class SignatureValue : Mx.Xml.Busdox.Smp.XmlCommonBase
    {
        #region Constructors
        /// <summary>
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
        ...
        {
            Mx.Xml.Busdox.ds.SignatureValue newObject = new Mx.Xml.Busdox.ds.SignatureValue(_elementName);
            newObject.m_Id = m_Id;
