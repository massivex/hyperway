...
namespace Mx.Xml.Busdox.ds
{
    ...
    public partial class SignatureMethod : Mx.Xml.Busdox.Smp.XmlCommonBase
    {
        #region Constructors
        /// <summary>
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
        ...
        {
            Mx.Xml.Busdox.ds.SignatureMethod newObject = new Mx.Xml.Busdox.ds.SignatureMethod(_elementName);
