...
namespace Mx.Xml.Busdox.ds
{
    ...
    public partial class Signature : Mx.Xml.Busdox.Smp.XmlCommonBase
    {
        #region Constructors
        /// <summary>
        ...
        protected override void Init()
        {
            ...
            m_Id = null;
            m_SignedInfo = new Mx.Xml.Busdox.ds.SignedInfo("SignedInfo");
            m_SignatureValue = new Mx.Xml.Busdox.ds.SignatureValue("SignatureValue");
            m_KeyInfo = null;
            m_Object = new Mx.Xml.Busdox.Smp.XmlObjectCollection<Mx.Xml.Busdox.ds.object_>("Object", "http://www.w3.org/2000/09/xmldsig#", 0, -1, false);
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
        ...
        {
            Mx.Xml.Busdox.ds.Signature newObject = new Mx.Xml.Busdox.ds.Signature(_elementName);
            newObject.m_Id = m_Id;
            newObject.m_SignedInfo = null;
            if (m_SignedInfo != null)
                newObject.m_SignedInfo = (Mx.Xml.Busdox.ds.SignedInfo)m_SignedInfo.Clone();
            newObject.m_SignatureValue = null;
            if (m_SignatureValue != null)
                newObject.m_SignatureValue = (Mx.Xml.Busdox.ds.SignatureValue)m_SignatureValue.Clone();
            newObject.m_KeyInfo = null;
            if (m_KeyInfo != null)
                newObject.m_KeyInfo = (Mx.Xml.Busdox.ds.KeyInfo)m_KeyInfo.Clone();
            foreach (Mx.Xml.Busdox.ds.object_ o in m_Object)
                newObject.m_Object.Add((Mx.Xml.Busdox.ds.object_)o.Clone());
...
// ##HAND_CODED_BLOCK_END ID="Additional clone"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
        ...
        /// </remarks>
        [LiquidTechnologies.Runtime.Standard20.ElementInfoSeqClsMnd("SignedInfo", "http://www.w3.org/2000/09/xmldsig#", LiquidTechnologies.Runtime.Standard20.XmlObjectBase.XmlElementType.Element, typeof(Mx.Xml.Busdox.ds.SignedInfo), true)]
        public Mx.Xml.Busdox.ds.SignedInfo SignedInfo
        {
            get 
            { 
                return m_SignedInfo;  
        ...
        protected Mx.Xml.Busdox.ds.SignedInfo m_SignedInfo;
        ...
        /// If this property is set, then the object will be COPIED. If the property is set to null an exception is raised.
        /// </remarks>
        [LiquidTechnologies.Runtime.Standard20.ElementInfoSeqClsMnd("SignatureValue", "http://www.w3.org/2000/09/xmldsig#", LiquidTechnologies.Runtime.Standard20.XmlObjectBase.XmlElementType.Element, typeof(Mx.Xml.Busdox.ds.SignatureValue), false)]
        public Mx.Xml.Busdox.ds.SignatureValue SignatureValue
        {
            get 
            { 
        ...
        protected Mx.Xml.Busdox.ds.SignatureValue m_SignatureValue;
        ...
        /// </remarks>
        [LiquidTechnologies.Runtime.Standard20.ElementInfoSeqClsOpt("KeyInfo", "http://www.w3.org/2000/09/xmldsig#", LiquidTechnologies.Runtime.Standard20.XmlObjectBase.XmlElementType.Element, typeof(Mx.Xml.Busdox.ds.KeyInfo))]
        public Mx.Xml.Busdox.ds.KeyInfo KeyInfo
        {
            get
            { 
                return m_KeyInfo;
        ...
        protected Mx.Xml.Busdox.ds.KeyInfo m_KeyInfo;
        ...
        public Mx.Xml.Busdox.Smp.XmlObjectCollection<Mx.Xml.Busdox.ds.object_> object_
        {
            get { return m_Object; }
        }
        protected Mx.Xml.Busdox.Smp.XmlObjectCollection<Mx.Xml.Busdox.ds.object_> m_Object;
