...
{
    /// <summary>
    /// This class represents the Element ReferenceParameters
    /// </summary>
    [LiquidTechnologies.Runtime.Standard20.XmlObjectInfo(LiquidTechnologies.Runtime.Standard20.XmlObjectBase.XmlElementGroupType.Sequence,
                                                    ...
                                                    "ReferenceParameters", "http://www.w3.org/2005/08/addressing", true, false, false)]
    public partial class ReferenceParameters : Mx.Xml.Busdox.Smp.XmlCommonBase
    {
        #region Constructors
        /// <summary>
        /// Constructor for ReferenceParameters
        /// </summary>
        /// <remarks>
        ...
        {
            _elementName = "ReferenceParameters";
            Init();
        }
        public ReferenceParameters(string elementName)
        {
...
// ##HAND_CODED_BLOCK_END ID="Additional Inits"## DO NOT MODIFY ANYTHING OUTSIDE OF THESE TAGS
        ...
        {
            Mx.Xml.Busdox.wsa.ReferenceParameters newObject = new Mx.Xml.Busdox.wsa.ReferenceParameters(_elementName);
